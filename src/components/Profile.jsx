...
function Profile() {
  return (
    <div className="w-[50%] m-auto flex pt-10 bg-white border-l-2  border-r-2">
      <div>
        <CgProfile className="text-blue-500 text-[5.5rem] mt-10 ml-5" />
      ...
      <div className="border-b-4 border-black px-6 mt-10">
        <p>
          Hi I am Avishek Biswakarma front end developer Lorem, ipsum dolor sit amet
          consectetur adipisicing elit. Corporis, pariatur.
        </p>
        <h1>
          <strong>Email</strong>:avishek.viswakarma@gmail.com
        </h1>
        <h1>
          <strong>Website</strong>:MoleSoft.com
        </h1>
      </div>
    </div>
  );
